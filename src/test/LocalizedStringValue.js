...
define(["../LocalizedStringValue", "ppwcode-vernacular-semantics/test/Value"],
  function(LocalizedStringValue, testGeneratorValue) {
    ...
    testGeneratorLocalizedStringValue(
      LocalizedStringValue,
      {
        language: "en",
        localizedText: "This is a text in English."
      },
      {
        language: "nl",
        localizedText: "Dit is een nederlandse tekst."
      }
    );

    return testGeneratorLocalizedStringValue;
  }
);
